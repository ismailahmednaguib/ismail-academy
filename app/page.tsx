...
export default function Home() {
  ...
  }, [settings.inkColor, settings.goldColor, settings.goldSoftColor, settings.paperColor, settings.creamColor, settings.sageColor, settings.siteDensity, settings.cornerStyle, settings.buttonStyle]);
  useEffect(() => {
