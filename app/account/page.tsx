...
export default async function AccountPage() {
  ...
  return <><SiteHeader settings={settings} /><main id="main" className="page-shell account-page"><MemberDashboard items={items} settings={settings} showMomentum={settings.showStudyMomentum} /><MemberProfileForm /></main><SiteFooter settings={settings} /></>;
}
