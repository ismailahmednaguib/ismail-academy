...
export default function NexusHomepage({ settings, courses, lessons, articles, books, search, setSearch, results, ownerSession, onOpenAdmin, onOpenInterest, onSubscribeNewsletter, newsletterSending }: Props) {
  ...
  const sectionMap: Record<string, ReactNode> = {
    start: settings.showNexusStart && <LearningLaunchpad eyebrow={settings.nexusStartEyebrow} title={settings.nexusStartTitle} text={settings.nexusStartText} exploreLabel={settings.nexusExploreAllLabel} countLabel={settings.nexusMaterialCountLabel} items={startLinks} />,
