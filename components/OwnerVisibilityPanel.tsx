...
const options: [VisibilityKey, string, string][] = [
  ...
  ["showPulseHeader", "رأس النسخة الجديدة", "الشعار والتنقل والحساب"],
  ["showPulseSearch", "بحث النسخة الجديدة", "زر البحث ونافذة البحث"],
  ["showPulseLanguage", "مبدّل اللغة", "داخل رأس الموقع"],
  ["showPulseTheme", "مبدّل الوضع الليلي", "داخل رأس الموقع"],
  ["showPulseAccount", "دخول وحساب الزائر", "يظهر للزائر فقط حسب حالته"],
  ["showPulseHeroRoute", "بطاقة المسار المقترح", "يمين الواجهة الرئيسية"],
  ["showPulseHeroTrust", "عبارات الثقة", "أسفل زر الواجهة الرئيسية"],
  ["showPulseHeroSecondaryCta", "زر استكشف المواد", "الزر الثانوي في الواجهة"],
  ["showPulseStrip", "الشريط التعريفي", "بين الواجهة وبداية المحتوى"],
  ["showPulseIntro", "مقدمة النسخة الجديدة", "العنوان والوصف قبل البوابات"],
  ["showPulseDirectory", "بوابات البداية", "دورات ودروس ومقالات ومكتبة"],
  ["showPulsePrograms", "قائمة المسارات", "الدورات المختارة في الرئيسية"],
  ["showPulseJournal", "قسم القراءة والاستماع", "مقال مميز ودروس مختارة"],
  ["showPulseDesk", "مكتب الطالب", "المحفوظات والإكمال من حيث توقفت"],
  ["showPulseEvent", "بطاقة المجلس", "الدعوة والاقتباس في الرئيسية"],
