...
const options: [VisibilityKey, string, string][] = [
  ...
  ["showIntro", "قسم التعريف", "بعد الواجهة"],
  ["showHero", "الواجهة الكلاسيكية", "العنوان والوصف القديم"],
  ["showSearch", "خانة البحث", "أسفل الواجهة"],
  ["showWorldGlobe", "كرة العالم", "خريطة الأعضاء"],
  ["showLearningShelf", "المحتوى المحفوظ", "للمستخدم المسجل"],
  ["showSpotlight", "الاختيارات المميزة", "3 بطاقات في الرئيسية"],
  ["showHomeSignals", "مؤشرات الرئيسية", "إحصائيات سريعة"],
  ["showHomeDirectory", "دليل الأقسام", "بوابات الدخول"],
  ["showCommunity", "قسم المجتمع", "خريطة الدول"],
  ["showStudyMomentum", "زخم التعلم", "حساب الطالب"],
  ["showRelatedContent", "المحتوى المرتبط", "أسفل صفحات التفاصيل"],
  ...
  ["showWisdom", "حكمة اليوم", "بطاقة الحكمة في الرئيسية"],
  ["showStats", "شريط الإحصائيات", "أرقام الأكاديمية"],
  ["showTestimonials", "آراء الطلاب", "قصص النجاح"],
  ["showFaqHome", "الأسئلة المختصرة", "في الرئيسية"],
  ["showCtaBanner", "بانر الدعوة", "دعوة البدء"],
